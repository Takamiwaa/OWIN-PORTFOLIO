...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen pb-20 pt-20" data-aos-duration="1000" data-aos="fade-down">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-lg shadow-lg text-sm font-medium transition-all ${
                activeTab === tab.value
                  ...
                  : "text-gray-800 dark:bg-black dark:text-white border border-white"
              }`}
            >
              ...
              <div className="grid gap-4 max-w-xl mx-auto lg:mx-0">
                {contactData.socials.map((item, index) => (
                  <a
                    ...
                    className="flex items-center justify-between gap-4 px-7 w-full  py-7 border border-white rounded-lg shadow-lg dark:bg-black text-gray-800 dark:text-white hover:shadow-lg hover:-translate-y-1 transition-all"
                    aria-label={item.label}
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 flex items-center justify-center shadow-lg rounded-lg bg-black text-white dark:bg-white dark:text-gray-800 shrink-0">
              ...
              <div className="rounded-lg py-12 px-7 shadow-lg border h-fit border-white max-w-xl w-full mx-auto lg:mx-0">
                ...
                <form className="grid gap-4">
                  <input
                    ...
                    className="p-3 rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-white text-sm focus:outline-none focus:ring-2 focus:ring-gray-800"
                  />
                  <input
                    type="email"
                  ...
                  <Tippy content="Send your message" placement="top">
                    <button
                      ...
                      className="px-4 py-3 bg-black text-white dark:bg-white dark:text-gray-800 rounded-lg font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1"
                    >
                      Send
          ...
          {activeTab === "support" && (
            <div className="grid gap-4 max-w-xl mx-auto" data-aos-delay="600" data-aos="fade-down">
              {contactData.supportPlatforms.map((item, index) => (
                <div
                  key={index}
                  className="dark:bg-black border border-white rounded-lg p-6 shadow-lg hover:-translate-y-1 transition-transform max-w-xl mx-auto"
                >
                  {item.type === "image" ? (
