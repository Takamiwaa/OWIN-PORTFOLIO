...
const CustomModal = ({ isOpen, onClose, children }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal Content */}
            <div className="relative bg-white dark:bg-black rounded-xl shadow-lg max-w-md w-full mx-4 transform transition-all">
                <button
                    onClick={onClose}
...
const Testimonials = () => {
    ...
    return (
        <section
            id="testimonials"
            className="pt-20 min-h-screen  overflow-hidden px-4 sm:px-6 lg:px-8"
        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                {/* Testimonial Card */}
                <div className="bg-white dark:bg-black rounded-lg mb-10 shadow-lg border border-white dark:border-white max-w-4xl mx-auto" data-aos-delay="600" data-aos="fade-up">
                    {/* Card Header */}
                    <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-black ml-3 text-white dark:bg-white dark:text-gray-800 rounded-lg font-medium  flex items-center gap-2 transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg"
                        ...
                        {testimonials.length > 0 ? (
                            <div className="space-y-6">
                                {testimonials.map((testimonial, index) => (
                                    <div
                                        key={testimonial.id}
                                        className="dark:border dark:border-white dark:bg-black rounded-lg p-4 transition-all duration-300"
                                        style={{
                    ...
                    <div className="grid gap-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    } dark:bg-black text-gray-800 dark:text-white text-sm focus:outline-none focus:ring-1 transition-colors`}
                                ...
                                <textarea
                                    ...
                                    className={`w-full pl-10 pr-4 py-2 rounded-lg border ${
                                        errors.content
                                            ? 'border-red-300 focus:border-red-500 focus:ring-red-200'
                                            : 'border-gray-200 dark:border-gray-700 focus:border-gray-800 focus:ring-gray-800'
                                    } dark:bg-black text-gray-800 dark:text-white text-sm focus:outline-none focus:ring-1 transition-colors resize-none`}
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <button
                                ...
                                className="flex-1 px-6 py-2 bg-black dark:bg-white text-white dark:text-gray-800 rounded-lg text-sm font-medium transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            >
                                {isSubmitting ? (
