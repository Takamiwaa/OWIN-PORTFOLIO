...
const Footer = () => {
  return (
    <section className="relative">
      ...
      >
        <source src="https://ia801606.us.archive.org/26/items/luffy-supreme-king-haki-burst-one-piece-moewalls-com/luffy-supreme-king-haki-burst-one-piece-moewalls-com.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div className="absolute top-0 left-0 w-full h-full bg-black/50 backdrop-blur-md z-10"></div>
      <footer className="relative z-20 text-gray-800 dark:text-white py-12">
